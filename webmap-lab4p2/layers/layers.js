...
var lyr_SLCo_Healthcare_Facilities_Tracts_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/SLCo_Healthcare_Facilities_Tracts_2_0.png" /> 0 - 0<br />\
    <img src="styles/legend/SLCo_Healthcare_Facilities_Tracts_2_1.png" /> 0 - 2<br />\
    <img src="styles/legend/SLCo_Healthcare_Facilities_Tracts_2_2.png" /> 2 - 5<br />\
    <img src="styles/legend/SLCo_Healthcare_Facilities_Tracts_2_3.png" /> 5 - 10<br />\
    <img src="styles/legend/SLCo_Healthcare_Facilities_Tracts_2_4.png" /> 10 - 17<br />' });
...
lyr_CartoLight_0.setVisible(true);lyr_SLCo_County_Boundary_1.setVisible(true);lyr_SLCo_Healthcare_Facilities_Tracts_2.setVisible(true);lyr_SLCo_Healthcare_Facilities_3.setVisible(true);
var layersList = [lyr_CartoLight_0,lyr_SLCo_County_Boundary_1,lyr_SLCo_Healthcare_Facilities_Tracts_2,lyr_SLCo_Healthcare_Facilities_3];
...
lyr_SLCo_Healthcare_Facilities_Tracts_2.set('fieldLabels', {'objectid': 'no label', 'geoid10': 'no label', 'total_count': 'no label', 'total': 'no label', });
