...
var style_SLCo_Healthcare_Facilities_Tracts_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("total");
    ...
    if (value >= 0.000000 && value <= 0.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.000000 && value <= 17.000000) {
            style = [ new ol.style.Style({
